...
export function NewsBanner({ onOpenConsultation }) {
  return (
    <div className="relative isolate overflow-hidden bg-[#2D0404] text-white">
      ...
      <div className="relative z-10 mx-auto max-w-[1360px] px-6 py-14 sm:py-16 lg:px-12 text-center">
        ...
        >
          ...
          <span className="font-semibold text-[#E5A93C]">Tin tức & Dự án</span>
        </nav>
        ...
        <div className="mt-2">
          ...
          >
            Kinh nghiệm tổ chức, kiến thức thiết bị & khoảnh khắc sự kiện thực tế
          </p>
        </div>
      </div>
    </div>
